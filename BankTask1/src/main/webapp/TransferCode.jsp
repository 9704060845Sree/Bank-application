...
try{
	...
	int accountnum1=accountnum;
	  ...
	  PreparedStatement qs=con.prepareStatement("select * from sdfc where accountnum=? and status='valid'");
	...
	int amount2=Integer.parseInt(request.getParameter("amo"));
		   ...
		   PreparedStatement us=con.prepareStatement("update sdfc set amount=? where accountnum=? and status='valid' ");
